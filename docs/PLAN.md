...
- 1) PM1 — Workspaces & Projects — ⏳ queued
- 2) PM2 — Управление задачами и иерархией — 🚀 in progress
...
- [x] Обновить task API под иерархию «Эпики → Задачи → Подзадачи» с неограниченной вложенностью.
- [x] Реализовать представления: Канбан, Список, Gantt (Timeline), Календарь и Таблица с общим состоянием и drag & drop сменой статусов.
- [x] Обновить карточку задачи, чек-листы, вложения, связи и time tracking (estimate/spent).
