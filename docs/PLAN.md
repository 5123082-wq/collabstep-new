...
- 0) PM0 — Актуализация требований и архитектуры — ✅ done @ HEAD <!-- // [PM:S0-900] stage sign-off -->
- 1) PM1 — Workspaces & Projects — 🛠️ implementation <!-- // [PM:S1-100] kickoff marker -->
...
- [x] Сверить выданное ТЗ с текущей дорожной картой Project Management и оформить фазы включения фич-флагов и HARD GATE-критерии.
- [x] Провести ревью существующих API и доменной модели проектов/задач, подготовить список расширений для ролей workspace, файловых связей и аудит-трека.
- [x] Согласовать артефакты Stage 0: архитектурную диаграмму и план миграций, обновить карту интеграций с соседними блоками.

### Этап PM1. Workspaces & Projects
- [x] Подготовить RFC по CRUD рабочих пространств, ролям Owner/Admin/Member/Viewer и разграничению приватности/видимости проектов.
  - [x] Финализировать схемы `workspace_roles` и протокол эскалации привилегий.
  - [x] Зафиксировать контракты API (REST + GraphQL) и стратегию версионирования.
- [ ] Реализовать миграции и сервисные методы для `accounts`, `org_members`, `project_members`, обеспечить мультиаккаунт и корректный ACL.
  - [ ] DB: добавить миграции `20240416_add_workspace_accounts` и `20240416_add_project_members` с откатами.
  - [ ] Backend: реализовать сервис `WorkspaceMembershipService` и интегрировать с существующей авторизацией.
  - [ ] QA: подготовить тестовые данные мультиаккаунта и прогнать миграции в staging.
- [ ] Расширить API проектов и шаблонов: типы проектов, бюджет, дедлайн, приватность и связь с workspace-ролями.
  - [ ] API: обновить эндпоинты `/projects` и `/templates` (REST + GraphQL) с новыми полями и проверками ролей.
  - [ ] Contracts: синхронизировать DTO/TypeScript типы и regenerate SDK.
  - [ ] Docs: обновить OpenAPI/GraphQL схемы и `docs/api/projects.md`.
- [ ] Переработать мастер создания проектов: новые поля, выбор workspace, проверка ролей и фич-флагов, сценарии one-click шаблонов.
  - [ ] UI: добавить шаг выбора workspace с ролями и ограничениями приватности.
  - [ ] UI: внедрить поля бюджета/дедлайна, поддержку типов проектов и one-click шаблонов.
  - [ ] QA: smoke-скрипт по мастеру и проверка фич-флагов `pm.projectCreator.v2`.
- [ ] Согласовать QA-план: smoke-тесты API/UI, фич-флаги и чек-лист включения HARD GATE по окончании этапа.
  - [ ] QA: составить чек-лист regression + функциональных сценариев.
  - [ ] Release: подготовить критерии включения HARD GATE и артефакты (build log, e2e-report).
