          ...
          >
            {section.href ? (
              ...
              <button
                type="button"
                className={clsx(
                  'group flex h-12 w-full items-center justify-center rounded-2xl border border-neutral-900/80 text-neutral-300 transition hover:border-indigo-500/40 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400',
                  active && 'border-indigo-500/40 text-white'
                )}
                aria-haspopup="true"
            ...
            {hasChildren && (
              <div
                className={clsx(
                  'pointer-events-none absolute left-[72px] top-0 z-40 hidden w-[260px] rounded-2xl border border-neutral-800/60 bg-neutral-900/60 p-4 shadow-[0_10px_40px_rgba(0,0,0,0.45)] backdrop-blur',
              ...
              >
                <div className="flex flex-col gap-3">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      type="button"
                      className="rounded-full border border-neutral-800/60 bg-neutral-900/70 px-2 py-1 text-[10px] uppercase tracking-wide text-neutral-400 transition hover:border-indigo-500/40 hover:text-white"
                      onClick={() => closeFlyout()}
                    >
                      Закрыть
                    </button>
