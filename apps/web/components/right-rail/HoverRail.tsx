  ...
  return (
    <>
      {shouldRenderRail ? (
        ...
        style={{ width: expanded ? RAIL_EXPANDED_WIDTH : RAIL_COLLAPSED_WIDTH, transition: 'width 200ms ease' }}
          ...
          <div className="pointer-events-auto flex h-full w-full flex-col rounded-2xl border border-neutral-800/80 bg-neutral-900/80 p-2 backdrop-blur">
            ...
            <div className="mt-auto border-t border-neutral-800/60 pt-3">
              <button
                ...
                className={cn(
                  'flex w-full items-center justify-center gap-2 rounded-xl border border-neutral-800/70 bg-neutral-950/70 px-3 py-2 text-sm font-medium text-neutral-200 transition hover:border-indigo-500/40 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400',
                  !expanded && 'h-12 p-0'
                )}
              >
                {expanded ? (
