...
export default function MarketingError({ error, reset }: SegmentErrorProps) {
  const digest = `marketing-${error.digest ?? 'unknown'}`;
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-neutral-950 px-6 text-neutral-100">
      <div className="max-w-md space-y-4 text-center">
        <h1 className="text-2xl font-semibold">Раздел временно недоступен</h1>
        <p className="text-sm text-neutral-300">
          Мы не смогли загрузить маркетинговую страницу. Обновите страницу или перейдите на главную.
        </p>
