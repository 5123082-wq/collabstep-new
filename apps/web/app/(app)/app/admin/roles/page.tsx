    ...
    <div className="space-y-6">
      <header className="space-y-3">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-neutral-50">Роли и разрешения</h1>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {roles.map((role) => (
          <div
            key={role.id}
            className="group relative rounded-2xl border border-neutral-800 bg-neutral-950/60 p-6 transition hover:border-indigo-500/40"
          >
