...
const techChecklist = [
  { id: 'tech-1', item: 'Оптимизировать скорость лендинга', status: 'В процессе', owner: 'Front-end', related: `${PROJECTS_HUB_PATH}/web` },
  { id: 'tech-2', item: 'Исправить дубли метатегов', status: 'Запланировано', owner: 'SEO-специалист', related: '/app/marketing/analytics' },
  { id: 'tech-3', item: 'Добавить схему FAQ', status: 'Готово', owner: 'Контент-команда', related: '/app/marketing/content-seo' }
];
        ...
        <div className="space-y-4 xl:col-span-2">
          ...
          >
            {calendarItems.map((item) => (
              <div key={item.id} className="flex flex-col gap-2 rounded-2xl border border-neutral-900/70 bg-neutral-950/60 p-4 md:flex-row md:items-center md:justify-between">
                <div>
          ...
          >
            {workflow.map((column) => (
              <div key={column.id} className="space-y-3 rounded-2xl border border-neutral-900/70 bg-neutral-950/60 p-4">
          ...
          >
            {seoClusters.map((cluster) => (
              <div key={cluster.id} className="space-y-2 rounded-2xl border border-neutral-900/70 bg-neutral-950/60 p-4">
        ...
        <div className="space-y-4">
          ...
          >
            {techChecklist.map((item) => (
              <div key={item.id} className="space-y-2 rounded-2xl border border-neutral-900/70 bg-neutral-950/60 p-4">
                <div className="flex flex-wrap items-center justify-between gap-3">
