        ...
        <div className="space-y-4 xl:col-span-2">
          ...
          >
            {integrations.map((integration) => (
              <div key={integration.id} className="space-y-2 rounded-2xl border border-neutral-900/70 bg-neutral-950/60 p-4">
          ...
          >
            {attributionModels.map((model) => (
              <div key={model.id} className="space-y-2 rounded-2xl border border-neutral-900/70 bg-neutral-950/60 p-4">
        ...
        <div className="space-y-4">
          ...
          >
            {utmTemplates.map((template) => (
              <div key={template.id} className="space-y-2 rounded-2xl border border-neutral-900/70 bg-neutral-950/60 p-4">
                <div className="flex flex-wrap items-center justify-between gap-3">
