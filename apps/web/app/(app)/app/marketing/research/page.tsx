...
const insightLinks = [
  ...
  },
  {
    ...
    link: '/app/marketing/content-seo'
  }
];
        ...
        <div className="space-y-4 xl:col-span-2">
          ...
          >
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-3 rounded-2xl border border-neutral-900/70 bg-neutral-950/60 p-4">
          ...
          >
            {socialMentions.map((mention) => (
              <div key={mention.id} className="flex flex-col gap-2 rounded-2xl border border-neutral-900/70 bg-neutral-950/60 p-4 md:flex-row md:items-center md:justify-between">
                <div>
        ...
        <div className="space-y-4">
          ...
          >
            {competitorBattlecards.map((competitor) => (
              <div key={competitor.id} className="space-y-2 rounded-2xl border border-neutral-900/70 bg-neutral-950/60 p-4">
