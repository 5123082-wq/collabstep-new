...
const actions: MarketingAction[] = [
  ...
  { label: 'Подключить рекламный аккаунт', href: '/app/marketing/analytics', variant: 'secondary' }
];
        ...
        <div className="space-y-4 xl:col-span-2">
          ...
          >
            {kanbanColumns.map((column) => (
              <div key={column.id} className="space-y-3 rounded-2xl border border-neutral-900/80 bg-neutral-950/60 p-4">
          ...
          >
            <div className="space-y-3 rounded-2xl border border-neutral-900/80 bg-neutral-950/60 p-4">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <p className="text-sm font-semibold text-white">{campaignDetails.name}</p>
                <Link
                  href={`${PROJECTS_HUB_PATH}/workspace`}
          ...
          >
            <div className="space-y-3 rounded-2xl border border-neutral-900/80 bg-neutral-950/60 p-4">
              ...
              <Link
                href="/app/marketing/content-seo"
        ...
        <div className="space-y-4">
          ...
          >
            {adAccounts.map((account) => (
              <div key={account.id} className="space-y-2 rounded-2xl border border-neutral-900/70 bg-neutral-950/60 p-4">
                <div className="flex items-center justify-between">
          ...
          >
            {automationRules.map((rule) => (
              <div key={rule.id} className="space-y-2 rounded-2xl border border-neutral-900/70 bg-neutral-950/60 p-4">
                <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <MarketingCard
            ...
            footer={
              <span>
                ...
                <Link href="/app/finance/expenses" className="text-indigo-200 hover:text-white">
                  раздела «Расходы»
                </Link>{' '}
                для контроля факта.
              </span>
          ...
          >
            <div className="space-y-2 text-xs text-neutral-300">
              <p>
                ...
                <Link href={`${PROJECTS_HUB_PATH}/my`} className="text-indigo-200 hover:text-white">Retail CRM</Link>
              </p>
